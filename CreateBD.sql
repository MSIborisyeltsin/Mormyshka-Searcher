CREATE USER SQL_Reader FROM LOGIN SQL_Reader
CREATE USER SQL_Writer FROM LOGIN SQL_Writer
CREATE USER SQL_Manager FROM LOGIN SQL_Manager
...
GO
GRANT VIEW DEFINITION ON FULLTEXT STOPLIST :: SearchStoplist TO SQL_Reader;
GO
...
GO
GO
GRANT SELECT, INSERT, UPDATE, DELETE ON Pages TO SQL_Writer
GO
...
GO
GRANT SELECT ON BannedUrlQuery TO SQL_Writer
GO
...
ALTER TABLE HiddenServiceLinks ADD CONSTRAINT PK_HiddenServiceLinks PRIMARY KEY CLUSTERED (HiddenService,HiddenServiceTarget)
GO
GRANT SELECT, INSERT, UPDATE ON HiddenServiceLinks TO SQL_Writer
GO
...
GO
GRANT INSERT ON ContactMessages TO SQL_Reader
GO
...
GO
GRANT SELECT,INSERT,DELETE ON CrawleRequest TO SQL_Manager
GO
