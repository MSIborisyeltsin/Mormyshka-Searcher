...
END
GO
GRANT EXECUTE ON Search2 TO SQL_Reader
GO
...
END
GO
GRANT EXECUTE ON SearchTitle TO SQL_Reader
GO
...
END
GO
GRANT EXECUTE ON SearchInnerText TO SQL_Reader
GO
...
END
GO
GRANT EXECUTE ON SearchUrl TO SQL_Reader
GO
...
END
GO
GRANT EXECUTE ON [SearchSite] TO SQL_Reader
GO
...
BEGIN
  ...
  IF (@MaxResult=1)
    ...
    SELECT Url, COALESCE(Title, p.HiddenService) Title, InnerText, CrawleError
        ...
        WHERE p.Url=@Url
END
GRANT EXECUTE ON [SearchCached] TO SQL_Reader
GO
